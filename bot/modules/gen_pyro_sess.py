...
from hydrogram.filters import command, user, text, private
from hydrogram.handlers import MessageHandler
from hydrogram.errors import SessionPasswordNeeded, FloodWait, PhoneNumberInvalid, ApiIdInvalid, PhoneCodeInvalid, PhoneCodeExpired, UsernameNotOccupied, ChatAdminRequired, PeerIdInvalid
...
async def genPyroString(client, message):
    global isStop
    session_dict.clear()
    sess_msg = await sendMessage(message, """⌬ <u><i><b>hydrogram String Session Generator</b></i></u>
...
<i>Send /stop to Stop Process</i>""")
    ...
    await sleep(1.5)
    await editMessage(sess_msg, """⌬ <u><i><b>hydrogram String Session Generator</b></i></u>
...
<i>Send /stop to Stop Process</i>""")
    ...
    try:
        ...
        await sleep(1.5)
        await editMessage(sess_msg, f"""⌬ <u><i><b>hydrogram String Session Generator</b></i></u>
